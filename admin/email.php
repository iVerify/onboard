                                ...
                                <td class='pdt-4x pdb-4x'>
                                    <table class='email-header'>
                                        ...
                                        <tr>
                                            <td class='text-center pdb-2-5x'>
                                                <center>
                                                    <a href='https://voteonline' target='_blank'><img class='email-logo' src='https://i.imgur.com/FcIx9F7.png' /></a>
                                                </center>
                                            </td>
                                        </tr>
                                        </tbody>
                                    ...
                                    <table class='email-body'>
                                        <div style='padding-left: 30px;'>
                                            <tbody>
                                            <tr>
                                                <td class='pd-3x pdb-1-5x'><h2 class='email-heading'>Welcome onboard!</h2></td>
                                            </tr>
                                            <tr>
                                                <td class='pdl-3x pdr-3x pdb-2x'>
                                                    <p class='mgb-1x'>Hello Chief,</p>
                                                    <p class='mgb-1x'>
                                                        You are receiving this email because you have subscribed to the VoteOnline <strong>Pro plan.</strong>
                                                    </p>
                                                    <p class='mgb-1x'><strong>You're requested to provide us with this:</strong></p>
                                                    <span><img src="https://i.imgur.com/0XacUTM.png" width="15px" style="display: inline-flex">Logo(PNG or SVG format)</span><br>
                                                    <span><img src="https://i.imgur.com/0XacUTM.png" width="15px" style="display: inline-flex">Company CAC certificate</span><br>
                                                    <span><img src="https://i.imgur.com/0XacUTM.png" width="15px" style="display: inline-flex">Paystack developer access</span><br>
                                                    <span><img src="https://i.imgur.com/0XacUTM.png" width="15px" style="display: inline-flex">Company Account Details</span>
                                                    <p class='mgb-1x'><strong>Vote URL/Admin Login:</strong></p>
                                                    <strong>Voting URL:</strong> https://mrsnigeria.voteonline.com.ng/<br>
                                                    <strong>Admin Login URL:</strong> https://mrsnigeria.voteonline.com.ng/admin<br>
                                                    <strong>Admin Password:</strong> Admin@2021!!
                                                    <p>Please note that the requested information above will be needed to complete setup, and a contract will be sent from our legal department will be sent to seal and bind the contract.</p>
                                                    <p class='email-note'>If you did not make this request, please contact us or ignore this message, if you face any issues, please contact us at help@voteonline.com.ng</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class='pd-3x pdt-2x pdb-3x'>
                                                    <p class='email-note' style='text-align: center;''>
                                                    © <script>document.write(new Date().getFullYear());</script> All Rights Reserved :: Powered by <a href='https://www.voteonline.com.ng' target='_blank' style='text-decoration: none;''>Vote Online&trade;</a>
                                                    </p>
                                                </td>
                                            </tr>
                                            </tbody>
