                                ...
                                <td class='pdt-4x pdb-4x'>
                                    <table class='email-header'>
                                        ...
                                        <tr>
                                            <td class='text-center pdb-2-5x'>
                                                <center>
                                                    <a href='https://iverify.ng' target='_blank'><img class='email-logo' src='https://i.imgur.com/5SNKhPM.png' /></a>
                                                </center>
                                            </td>
                                        </tr>
                                        </tbody>
                                    ...
                                    <table class='email-body'>
                                        <div style='padding-left: 30px;'>
                                            <tbody>
                                            <tr>
                                                <td class='pd-3x pdb-1-5x'><h2 class='email-heading'>Account Login Details</h2></td>
                                            </tr>
                                            <tr>
                                                <td class='pdl-3x pdr-3x pdb-2x'>
                                                    <p class='mgb-1x'>Hello $firstName,</p>
                                                    <p class='mgb-1x'>
                                                        You are receiving this email because you're now a member of the iVerify Field Agent.
                                                    </p>
                                                    <p class='mgb-1x'>Copy the Agent ID below and keep safe.</p>
                                                    <strong>Agent ID:</strong> $agentID
                                                    <p>If you did not make this request, please contact us or ignore this message.</p>
                                                    <p class='email-note'>This is an automatically generated email please do not reply to this email. If you face any issues, please contact us at help@iverify.ng</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class='pd-3x pdt-2x pdb-3x'>
                                                    <p class='email-note' style='text-align: center;''>
                                                    © <script>document.write(new Date().getFullYear());</script> All Rights Reserved :: Powered by <a href='https://www.iverify.ng' target='_blank' style='text-decoration: none;''>iVerify&trade;</a>
                                                    </p>
                                                </td>
                                            </tr>
                                            </tbody>
...
// More headers
$headers .= 'From: iVerify™ <donotreply@iverify.ng>' . "\r\n";
