                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sharetakenup" class="form-control" placeholder="10 Million Naira">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label">Annual Returns Status (If Any)</label>
                                            <input type="text" name="annualreturns" class="form-control" placeholder="10 Million Naira">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label">Registered Charges (If Any)</label>
                                            <input type="text" name="registeredcharges" class="form-control" placeholder="10 Million Naira">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label">ompany Secretary</label>
                                            <input type="text" name="companysecretary" class="form-control" placeholder="10 Million Naira">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
