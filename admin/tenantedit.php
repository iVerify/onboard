    ...
    <div class="container-fluid">
        <div class="header-body">
            <div class="row align-items-center text-center py-4">
                <div class="pl-3">
                    <a href="tenant-verifications" class="btn btn-icon btn-default" type="button">
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-country">Tenant's Work Addressn</label>
                                                <input type="text" name="twaddress" required class="form-control" value="<? echo $twaddress ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-country">Work Address Landmark & Description</label>
                                                <input type="text" name="twaddressdesc" class="form-control" value="<? echo $twaddressdesc ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-city">Work Address Met with Last Name</label>
                                    ...
                                    <div class="text-center text-white">
                                        <div class="form-group">
                                            <button name="tenant_update_btn" class="btn btn-icon btn-default" type="submit">
