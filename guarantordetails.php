    ...
    <div class="container-fluid">
        <div class="header-body">
            <div class="row align-items-center text-center py-4">
                <div class="pl-3">
                    <a href="guarantor-reports" class="btn btn-icon btn-default" type="button">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th style="background-color: #ececef; "><strong>Guarantor First Name:</strong></th>
                                            <td><? echo $rpfirstname ?></td>
                                        </tr>
                                        <tr>
                                            <th style="background-color: #ececef; "><strong>Guarantor Last Name:</strong></th>
                                        ...
                                        <tr>
                                            <th style="background-color: #ececef; "><strong>Guarantor Work Address:</strong></th>
                                            <td><? echo $twaddress ?></td>
                                        </tr>
                                        <tr>
                                            <th style="background-color: #ececef; "><strong>Guarantor Work Address Landmark & Description:</strong></th>
