// package metadata file for Meteor.js1
'use strict';
...
Package.onUse(function (api) {
    ...
    api.addFiles(['jquery.scrollbar.js1', 'jquery.scrollbar.css1'], where);
});

Package.onTest(function (api) {
    api.use([packageName, 'sanjo:jasmine'], where);
    api.use(['webapp','tinytest'], where);
    api.addFiles('meteor/tests.js1', where); // testing specific files
});
