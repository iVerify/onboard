...
if(isset($_POST['pwa_btn'])) {
    ...
    $query = "INSERT INTO previouswork (agentID, reportID, firstName, lastName, clientName, rpVisitDate, rpFirstName, rpLastName, rpAddress, rpAddressDesc, mwFirstName, mwLastName, mwOccupation, eDuration, Conduct, wResignation, rpAgentRemark, rpUpload, rpUpload1, rpLatitude, rpLongitude)"
        . "VALUES ('$agentID', '$reportID', '$firstName', '$lastName', '$clientName', '$rpVisitDate', '$rpFirstName', '$rpLastName', '$rpAddress', '$rpAddressDesc', '$mwFirstName', '$mwLastName', '$mwOccupation', '$eDuration', '$Conduct', '$wResignation', '$rpAgentRemark', '$rpUpload_path', '$rpUpload1_path', '$rpLatitude', '$rpLongitude')";
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data">
                                    <h6 class="heading-small text-muted mb-4">Previous Work information</h6>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-address">Residential Address</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="eDuration" class="form-control" placeholder="Two Years">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-country">Attitude and Conduct</label>
                                                <input type="text" name="Conduct" required class="form-control" placeholder="Well coordinated and professional">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-country">Reason for leaving</label>
                                                <input type="text" name="wResignation" class="form-control" placeholder="Got employment elsewhere">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                    ...
                                    <div class="text-center text-white">
                                        <div class="form-group">
                                            <button name="pwa_btn" class="btn btn-icon btn-default" type="submit">
