            ...
            <div class="header-body">
                <div class="row align-items-center text-center py-4">
                    ...
                    <div class="col-lg-12">
                        ...
                        <p>What we ever hope to do with ease, we must first learn to do with diligence. <span style='font-size:15px;'>&#128519;</span></p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <a href="guarantor-report-upload">
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <a href="previous-work-report-upload">
