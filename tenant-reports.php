    ...
    <div class="container-fluid">
        <div class="header-body">
            <div class="row align-items-center text-center py-4">
                <div class="pl-3">
                    <a href="view-report-category" class="btn btn-icon btn-default" type="button">
                                ...
                                <div class="table-responsive">
                                    <div>
                                        <table class="table align-items-center">
                                            ...
                                            <tbody class="list">
                                            <?php
                                            $select_query = "SELECT * FROM tenant  WHERE agentid = '$agentid' ORDER BY date ASC";;
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td class='text-right'>"
                                                        ."<a href=\"tenantdetails.php?id=$id\" class=\"btn btn-icon btn-default\" type=\"button\">
